...
const faqs = [
	...
	},
	{
		...
		answer:
			'Todos los planes incluyen soporte. Los planes Pro y Business cuentan con prioridad mayor según el caso de uso.',
	},
	{
	...
	},
	{
		...
		answer:
			'Sí, el plan Free te permite empezar sin tarjeta de crédito y evaluar el flujo principal antes de subir de plan.',
	},
	{
						...
						>
							<CardContent className="p-5">
								<details className="group">
									<summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-left text-lg font-medium tracking-[-0.03em] text-neutral-950 [&::-webkit-details-marker]:hidden">
										{faq.question}
